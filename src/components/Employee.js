...
function Employee(props) {
  return (
    <div className="tw-min-w-[350px] tw-max-w-[350px]  tw-m-2 tw-py-8 tw-px-8 tw-max-w-sm tw-bg-white tw-rounded-xl tw-shadow-lg tw-space-y-2 sm:tw-py-4 sm:tw-flex sm:tw-items-center sm:tw-space-y-0 sm:tw-space-x-6">
      <img
